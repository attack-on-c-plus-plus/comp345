...
//------------------------------------------------------------------------------------------------------
    ...
    std::cout << "\nPlayer Information:\nThe Player \"" << player.getName() << "\" Has the following Territories:" << std::endl;
...
//------------------------------------------------------------------------------------------------------
    ...
    Deck deck;
    deck.addCard(Card("Card1"));
    deck.addCard(Card("Card2"));
    deck.addCard(Card("Card3"));
    ...
    {
        std::cout << "Card " << i + 1 << ": " << hand.getCard(i).getCardType() << std::endl;
    }
    std::cout << "\n" << std::endl;
...
//------------------------------------------------------------------------------------------------------
   // Territories + Player Relation Testing : "Player contains methods toDefend() and toAttack() that return a list of territories that are to be defended and to be attacked, respectively. "
    ...
    std::cout << "\nPlayer Information:\nPlayer " << playerA.getName() << "\" Has the following Territories:" << std::endl;
    ...
    std::cout << "\nPlayer Information:\nPlayer " << playerB.getName() << "\" Has the following Territories:" << std::endl;
